...
class LoadMonitoringSystem:
    def __init__(self, root):
        ...
        # Thresholds
        self.voltage_threshold = 400
        self.current_threshold = 4.7
    ...
    def fetch_data(self):
        ...
        voltage = random.uniform(220, 240)  # Simulated voltage
        current = random.uniform(0, 5)      # Simulated current
    ...
    def monitor_data(self):
        if self.running:
            ...
            self.root.after(1000, self.monitor_data)
    ...
    def log_data(self, data):
        ...
        with open("energy_data.csv", "a", newline="") as file:
            ...
            writer.writerow([data['voltage'], data['current'], data['power']])
        ...
        if file_path:
            with open(file_path, "w", newline="") as file:
                ...
                for entry in self.data_log:
                    writer.writerow([entry['voltage'], entry['current'], entry['power']])
