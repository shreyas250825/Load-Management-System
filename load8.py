...
def check_alerts(data):
    ...
    if data["voltage"] > voltage_threshold:
        messagebox.showwarning("Alert", f"Voltage exceeded! Current: {data['voltage']} V")
    if data["current"] > current_threshold:
        messagebox.showwarning("Alert", f"Current exceeded! Current: {data['current']} A")
    if data["power"] > power_threshold:
        messagebox.showwarning("Alert", f"Power exceeded! Current: {data['power']} W")
